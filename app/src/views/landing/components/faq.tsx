  ...
  return (
    <section id="faq" aria-labelledby="faq-title" className="scroll-mt-16 border-t border-hairline">
      <Container className="grid gap-12 py-20 lg:grid-cols-12 lg:gap-16 lg:py-28">
        ...
        <Accordion defaultValue={[LandingFaqs[0].question]} className="lg:col-span-7">
          {LandingFaqs.map((faq) => (
            <AccordionItem key={faq.question} value={faq.question} className="border-hairline">
              ...
              <AccordionContent keepMounted className="max-w-[58ch] pb-6 text-base leading-[1.6] tracking-[0.01em] text-body">
                <p>{faq.answer}</p>
              </AccordionContent>
            </AccordionItem>
          ))}
